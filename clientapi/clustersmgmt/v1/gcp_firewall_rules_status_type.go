...
// GcpFirewallRulesStatusKind is the name of the type used to represent objects
// of type 'gcp_firewall_rules_status'.
const GcpFirewallRulesStatusKind = "GcpFirewallRulesStatus"

// GcpFirewallRulesStatusLinkKind is the name of the type used to represent links
// to objects of type 'gcp_firewall_rules_status'.
const GcpFirewallRulesStatusLinkKind = "GcpFirewallRulesStatusLink"

// GcpFirewallRulesStatusNilKind is the name of the type used to nil references
// to objects of type 'gcp_firewall_rules_status'.
const GcpFirewallRulesStatusNilKind = "GcpFirewallRulesStatusNil"
...
func (o *GcpFirewallRulesStatus) Kind() string {
	if o == nil {
		return GcpFirewallRulesStatusNilKind
	}
	if len(o.fieldSet_) > 0 && o.fieldSet_[0] {
		return GcpFirewallRulesStatusLinkKind
	}
	return GcpFirewallRulesStatusKind
}

// Link returns true if this is a link.
func (o *GcpFirewallRulesStatus) Link() bool {
	return o != nil && len(o.fieldSet_) > 0 && o.fieldSet_[0]
}

// ID returns the identifier of the object.
func (o *GcpFirewallRulesStatus) ID() string {
...
func (o *GcpFirewallRulesStatus) GetID() (value string, ok bool) {
...
func (o *GcpFirewallRulesStatus) HREF() string {
...
// link has a value.
func (o *GcpFirewallRulesStatus) GetHREF() (value string, ok bool) {
...
// the zero value of the type if the attribute doesn't have a value.
//
// Overall state of the firewall rules (e.g. "pending", "ready", "error").
...
// Kind returns the name of the type of the object.
func (l *GcpFirewallRulesStatusList) Kind() string {
	if l == nil {
		return GcpFirewallRulesStatusListNilKind
	}
	if l.link {
		return GcpFirewallRulesStatusListLinkKind
	}
	return GcpFirewallRulesStatusListKind
}

// Link returns true iif this is a link.
func (l *GcpFirewallRulesStatusList) Link() bool {
	return l != nil && l.link
}

// HREF returns the link to the list.
func (l *GcpFirewallRulesStatusList) HREF() string {
	if l != nil {
		return l.href
	}
	return ""
...
// link has a value.
func (l *GcpFirewallRulesStatusList) GetHREF() (value string, ok bool) {
	ok = l != nil && l.href != ""
	if ok {
		value = l.href
	}
